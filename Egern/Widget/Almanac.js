 ...
 * 🔗 自用仓库: https://raw.githubusercontent.com/DwanWu/codex-upload-files/main/Egern/Widget/Almanac.js
 * ==========================================
 */
...
export default async function(ctx) {
  ...
  const mediumConfig = { fz: 12, icz: 13, lw: 52, maxW: 48, headerFz: 15, topIconFz: 11, gap: 6 };
  const largeConfig  = { fz: 14, icz: 15, lw: 60, maxW: 38, headerFz: 17, topIconFz: 12, gap: 8 };
