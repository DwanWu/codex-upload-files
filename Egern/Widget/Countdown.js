 ...
 *
 * 仓库地址: https://raw.githubusercontent.com/DwanWu/codex-upload-files/main/Egern/Widget/Countdown.js
...
export default async function (ctx) {
  ...
  const smallRefreshTimeStr = refreshTimeStr;
    ...
    return {
      ...
      children: [
        mkRow([
          ...
          mkSpacer(),
          mkIcon("arrow.triangle.2.circlepath", C.muted, 10),
  ...
  rightHeaderElements.push(mkIcon("arrow.triangle.2.circlepath", C.muted, layoutConfig.topFz));
